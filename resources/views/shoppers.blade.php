...
<div class="collapse navbar-collapse" id="nav_list">
          <ul class="nav navbar-nav navbar-right">
            <li ><a href="/">Home</a></li>
            <li class="active"><a href="shoppers">For Shoppers</a></li>
          ...
          <div class="container text-center">
            <div class="row">
              <div class="banner_text">
                <h4><span>Never loose</span>  <h3> a receipt again</h3>  <h4><span> with our digital receipt app</span></h4></h4>
                <p>
...
environmental benefits, and rewards.
          ...
          <div class="col-sm-6">
            <div class="about_left text-center">
              ...
              <img src="images/ForShoppers.png" alt="" >
